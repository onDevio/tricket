...
router.get('/reports', function(req, res) {
  res.render('dashboard/reports.html', {user: req.user, customer: req.query.customer, show: req.query.show, search: req.query.search, start: req.query.start, end: req.query.end });
});
